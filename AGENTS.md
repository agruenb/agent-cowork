...
- **Editor Tabs (Tab Bar)**:
  ...
  - The Light Theme (`Agent Cowork Light`) renders harmonious browser tabs: a darker slate backdrop (`editorGroupHeader.tabsBackground: #e2e8f0`), borderless tab integration (`tab.border: #00000000`, `editorGroupHeader.tabsBorder: #00000000`), default obsidian black tabs and selection (`tab.activeBackground: #0f172a`, `tab.activeForeground: #ffffff`), dynamically customized per active file via filename-based pastel tinting.
