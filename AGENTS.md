...
- **Editor Tabs (Tab Bar)**:
  ...
  - The Light Green Theme (`Agent Cowork Light`) renders harmonious browser tabs: a soft light slate bar (`editorGroupHeader.tabsBackground: #e8edf2`), clean baseline border (`editorGroupHeader.tabsBorder: #cbd5e1`), soft divider borders (`tab.border: #cbd5e1`), and a pure white active tab (`tab.activeBackground: #ffffff`) with an emerald accent top bar (`tab.activeBorderTop: #059669`) connecting seamlessly to the white editor canvas (`tab.activeBorder: #ffffff`).
